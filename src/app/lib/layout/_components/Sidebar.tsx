...
import { FileText, MousePointer, Image, CreditCard, Minus, SquareStack } from "lucide-react";
...
const COMPONENTS: { type: ElementType; label: string; icon: React.ReactNode }[] = [
  { type: "section", label: "Section", icon: <SquareStack className="w-4 h-4" /> },
...
function SidebarItem({ type, label, icon }:{ type: ElementType; label: string; icon: React.ReactNode }) {
