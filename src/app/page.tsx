...
import { DndContext, DragEndEvent, DragStartEvent, rectIntersection, useSensor, PointerSensor, useSensors, DragOverlay } from '@dnd-kit/core';
  ...
  const handleDragEnd = (event: DragEndEvent) => {
    ...
    if (active.data.current?.fromSidebar) {
      ...
      if (type !== 'section' && targetParentId === null) {
        alert("Bạn chỉ có thể thêm các component khác vào bên trong một Section.");
        return;
      }
